...
inline NeuronTree convertMsg2NT(QStringList pointlist, int client, int user, int isMany, int mode) {
...
inline vector<V_NeuronSWC>::iterator findseg(vector<V_NeuronSWC>::iterator begin, vector<V_NeuronSWC>::iterator end,
                                             V_NeuronSWC seg) {
